...
public class CastingTests {
    ...
    void floatToIntComparison() {
        ...
        // Int is default
        parseFilterExpAndCompare("$.intBin1 > $.floatBin1.asInt()", expectedExp);
        parseFilterExpAndCompare("$.intBin1.get(type: INT) > $.floatBin1.asInt()", expectedExp);
    }

    @Test
    void intToFloatComparison() {
        parseFilterExpAndCompare("$.intBin1.get(type: INT) > $.intBin2.asFloat()",

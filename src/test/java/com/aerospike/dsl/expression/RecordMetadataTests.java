...
class RecordMetadataTests {
    ...
    void deviceSize() {
        ...
        parseFilterExpAndCompare(input, expected);
    }
    ...
    void digestModulo() {
        ...
        parseFilterExpAndCompare(input2, expected2);
    }
    ...
    void lastUpdate() {
        ...
        parseFilterExpAndCompare(inputMetadataRight, expectedRight);
    }
